...
import com.c0rdination.openwidgets.util.FileUtils;
import com.c0rdination.openwidgets.util.TimeUtils;

public class Logger extends com.c0rdination.openwidgets.util.base.BaseLogger {
    ...
    public void printLog(String message) {
        ...
        if (filePath != null && isLoadedFromFile)
            FileUtils.write(filePath, logsData);
    }
    ...
    public void clear(String message) {
        logsData = "";
        if (Paths.getAppFilePath() != null)
            FileUtils.write(Paths.getAppFilePath() + LOG_FILE, "");
    ...
    public boolean isCleared() {
        if (Paths.getAppFilePath() != null)
            return FileUtils.read(Paths.getAppFilePath() + LOG_FILE).length() <= 2;
